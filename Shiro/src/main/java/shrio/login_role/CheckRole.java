 ...
 */
public class CheckRole extends BaseLogin {
    @Test
    public void testHasRole(){
        login("classpath:shiro/login-role/shiro-role.ini", "zhang", "123");
    ...
    public void testCheckPerssion(){
        login("classpath:shiro/login-role/shiro-permission.ini","wang","123");
